export type QuestionIntelligenceErrorCode =
  ...
  | "QUESTION_UNDERSTANDING_SESSION_NOT_FOUND"
  | "QUESTION_UNDERSTANDING_QUESTION_NOT_FOUND"
  | "QUESTION_UNDERSTANDING_QUESTION_UNDONE"
  | "QUESTION_UNDERSTANDING_OWNERSHIP_MISMATCH"
  | "QUESTION_UNDERSTANDING_STALE_REVISION"
  | "QUESTION_UNDERSTANDING_ACTION_DUPLICATE";
